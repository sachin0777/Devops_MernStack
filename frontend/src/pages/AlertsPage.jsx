      ...
      <main className="max-w-7xl mx-auto py-6 px-4 lg:px-8">
        ...
        {showPopup && selectedAlert && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
            <motion.div
              className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-lg shadow-2xl p-6 w-full max-w-3xl"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                <button
                  className="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-md shadow-lg transition"
                ...
                <button
                  className="flex items-center justify-center bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-md shadow-lg transition"
                ...
                <button
                  className="flex items-center justify-center bg-yellow-500 hover:bg-yellow-600 text-white py-3 px-6 rounded-md shadow-lg transition"
                ...
                <button
                  className="flex items-center justify-center bg-red-500 hover:bg-red-600 text-white py-3 px-6 rounded-md shadow-lg transition"
                  onClick={() => handleDeleteAlert(selectedAlert._id)}
                >
                  <FiTrash2 className="w-6 h-6 mr-2" /> Delete Alert
                </button>
              </div>

              <div className="flex justify-center mt-4">
                <button
                  className="bg-gray-700 hover:bg-gray-800 text-white py-2 px-4 rounded-md shadow-lg transition"
