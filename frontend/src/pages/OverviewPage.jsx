...
// import { useEffect, useState } from "react";
// import { AlertCircle, AlertOctagon, AlertTriangle, Camera, CameraOff, Cctv, CheckCircle, Zap, PlusCircle, MinusCircle } from "lucide-react";
// import { motion } from "framer-motion";
// import { FiRefreshCcw } from "react-icons/fi";
...
//         autoplay
//         loop
//         src="DoomCCTV.json" // Replace with the actual path to your Lottie JSON file
//         className="w-32 h-32"
//       />
...
//         {/* Logo */}
//         <img
//           src="unisys_logo.png" // Replace with the actual path to your logo
//           alt="ZenSafe Logo"
//           className="w-20 h-15 object-contain mb-3"
//         />

//         {/* Text */}
//         <div className="text-3xl font-bold tracking-wide mt-1 mb-3">
...
//         {/* Paragraph */}
//         <p className="text-gray-500 text-lg max-w-2xl mt-1">
//           ZenSafe leverages the power of artificial intelligence, quantum computing, and generative AI to redefine CCTV crime detection. Our platform ensures proactive safety, real-time alerts, and enhanced public confidence through state-of-the-art technology.
//         </p>
//       </div>
//     </div>
//   );
...
//   // Function to handle increase/decrease of alert counts
//   const handleCountChange = (index, type) => {
//     const updatedStats = [...stats];
//     const change = type === 'increase' ? 1 : -1;
//     updatedStats[index].value += change;
...
//   // Function to save updated stats to the database
//   const saveUpdatesToDB = async () => {
//     try {
//       await fetch("http://localhost:5000/api/dashboard/update-stats", {
//         method: "POST",
...
//     setIsEditing(!isEditing);
//     if (isEditing) {
//       saveUpdatesToDB(); // Save changes when exiting edit mode
//     }
//   };

//   return (
//     <div className="flex-1 overflow-auto relative z-10">
//       {/* <Header title="ZenSafe - AI and Quantum-Powered CCTV Crime Detection with GenAI" /> */}
